...
export default function DashboardPage() {
  const { totalMembers, activeSubscriptions, monthlySimulations, monthlyRevenue, trends } =
    dashboardStats
  ...
  const totalSub = subscriptionBreakdown.reduce((s, b) => s + b.count, 0)
        ...
        <div className="lg:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={monthlySimulationTrend} margin={{ top: 8, right: 8, left: -16, bottom: 0 }}>
